...
-- fixed
	SWEP.VElements = {
		["weapon"] = { type = "Model", model = "models/warz/melee/powerdrill.mdl", bone = "v_weapon.Knife_Handle", rel = "", pos = Vector(0, 0, 3), angle = Angle(-3.069, 273.113, 3.068), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
	SWEP.WElements = {
		["weapon"] = { type = "Model", model = "models/warz/melee/powerdrill.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.181, 1, -1.728), angle = Angle(180, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
